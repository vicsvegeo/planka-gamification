...
import styles from './EditSoftDueDateStep.module.scss';

const EditSoftDueDateStep = React.memo(({ cardId, onBack, onClose }) => {
  const selectCardById = useMemo(() => selectors.makeSelectCardById(), []);

  const defaultValue = useSelector((state) => selectCardById(state, cardId).softDueDate);
...
EditSoftDueDateStep.propTypes = {
  cardId: PropTypes.string.isRequired,
  onBack: PropTypes.func,
  onClose: PropTypes.func.isRequired,
};

EditSoftDueDateStep.defaultProps = {
  onBack: undefined,
};

export default EditSoftDueDateStep;
